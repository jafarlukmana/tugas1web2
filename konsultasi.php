    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                    <h3 align="center">Langsung saja, silahkan jawab pertanyaan berikut dengan jujur</h3><br><br><br><br>
                            <?php
                            include "config.php";
                            $query=mysql_query("select * from gejala where id_gejala='g10'");
                            ?>
                                <?php
                            ...
                            <td width="30%">
                                ...
                                <a href="g7.php" class="btn btn-info">Ya</a>
                                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                <a href="g8.php" class="btn btn-info">Tidak</a>
